...
def generate_code(token, link, output_path):
    ...
    def get_color(element):
        ...
        ele_r = element["backgroundColor"]['r'] * 255
        ele_g = element["backgroundColor"]['g'] * 255
        ele_b = element["backgroundColor"]['b'] * 255
        
        
        hex_code = ('#%02x%02x%02x' % (round(ele_r), round(ele_g), round(ele_b)))
...
generate_code("figd_yygD2FdLj76hIBycFOOZ1jyH-AXX0tnKI8uMn-Vd", "https://www.figma.com/file/QrzNC2KkqQJdo0wY1RbeNL/Untitled?node-id=0%3A3&t=34QgRva1KYbCNtxd-1", "X:\Smartie 2.0\Tests\Tkinter animated test\GUI")
